...
const UI={
 en:{
  ...
  chat:{beto:["We poured El Mercado's slab. Now look at it, primo — a whole store.","Don Güero says the next lot is already asking questions."],
        ...
        chava:["Everything is chile. Ask anybody.","The scale and I have an understanding.","Twenty-six years and never once wrong about the meat. The computer can relax."]},
  arrive:{hq:"Meridian HQ.",f2:"Floor 2 — expansion space. Quiet up here… for now.",st:"Street level. Mind the crosswalk.",lc:"La Cocina — smells like consommé and opportunity.",lo:"La Obra's studio — you helped build this. Every drawing here becomes a building.",ex:"Calle Dos — the town grows east.",me:"El Mercado Robles — Week Two starts here. Mind the mop."},
...
4. Nothing posts as ${p.n} without human approval. ${p.n} cannot approve. ${p.n} is a very good pet.`,
 ...
 es:{
  ...
  chat:{beto:["Ya colamos la losa de El Mercado. Míralo, primo — una tienda entera.","Don Güero dice que el siguiente lote ya anda haciendo preguntas."],
        ...
        chava:["Todo es chile. Pregúntale a quien sea.","La báscula y yo tenemos un acuerdo.","Veintiséis años y ni una vez me he equivocado con la carne. La computadora puede relajarse."]},
  arrive:{hq:"Meridian HQ.",f2:"Piso 2 — espacio de expansión. Tranquilo por aquí… por ahora.",st:"Nivel de calle. Cuidado con el cruce.",lc:"La Cocina — huele a consomé y a oportunidad.",lo:"El estudio de La Obra — tú ayudaste a construirlo. Cada dibujo de aquí se vuelve un edificio.",ex:"Calle Dos — el pueblo crece al este.",me:"El Mercado Robles — aquí empieza la Semana Dos. Aguas con el trapeador."},
