...
**Level:** ${lv}  ·  **XP:** ${x}/${mx}  ·  **Hearts:** ${he}/3`,
  ...
  repRole:(c,q,pct)=>`${c} decisions across ${q} ${q===1?"quest":"quests"} · ${pct}% first try`,
...
4. Nothing posts as ${p.n} without human approval. ${p.n} cannot approve. ${p.n} is a very good pet.`,
  ...
  lbTheme:"Color theme",
  updToast:"updated! New stuff is in.",lbCam:"Camera",camTop:"🗺️ Top-down",camIso:"◆ Isometric",isoEdit:"Switch the camera to Top-down to edit tiles.",lbMusic:"Music",musOn:"🔊 On",musOff:"🔇 Muted",tunes:["🎼 Auto","Lo-fi","Bells","Marimba","Dusk"],
...
**Nivel:** ${lv}  ·  **XP:** ${x}/${mx}  ·  **Vidas:** ${he}/3`,
  ...
  repRole:(c,q,pct)=>`${c} decisiones en ${q} ${q===1?"misión":"misiones"} · ${pct}% al primer intento`,
...
4. Nada se publica como ${p.n} sin aprobación humana. ${p.n} no puede aprobar. ${p.n} es una gran mascota.`,
  ...
  updToast:"¡actualizado! Hay cosas nuevas.",lbCam:"Cámara",camTop:"🗺️ Cenital",camIso:"◆ Isométrica",isoEdit:"Cambia la cámara a Cenital para editar casillas.",lbMusic:"Música",musOn:"🔊 Activa",musOff:"🔇 Silenciada",tunes:["🎼 Auto","Lo-fi","Campanas","Marimba","Atardecer"],
