...
const UI={
 en:{
  ...
  locs:{hq:"Meridian HQ",f2:"Floor 2 · Expansion",st:"Meridian Street",lc:"La Cocina",lo:"La Obra · Studio",ex:"Calle Dos · Expansion block",me:"El Mercado Robles"},
  ...
  arrive:{hq:"Meridian HQ.",f2:"Floor 2 — expansion space. Quiet up here… for now.",st:"Street level. Mind the crosswalk.",lc:"La Cocina — smells like consommé and opportunity.",lo:"La Obra's studio — you helped build this. Every drawing here becomes a building.",ex:"Calle Dos — the town grows east. El Mercado is going up.",me:"El Mercado Robles — cilantro, cumbia on a radio, and a business with opinions."},
...
4. Nothing posts as ${p.n} without human approval. ${p.n} cannot approve. ${p.n} is a very good pet.`,
  ...
  lbTheme:"Color theme",
  updToast:"updated! New stuff is in.",lbCam:"Camera",camTop:"🗺️ Top-down",camFront:"🏘 Front 2.5D",camIso:"◆ Isometric",
  ...
  howl:"AWOOOOO…",
  beagleTreat:["A treat! The tail achieves liftoff.","He accepts it gently, like a gentleman.","Crunch. You are his favorite person for the next hour.","Fueled up — he'd fetch anything for you right now."],isoEdit:"Switch the camera to Top-down to edit tiles.",lbMusic:"Music",musOn:"🔊 On",musOff:"🔇 Muted",tunes:["🎼 Auto","Lo-fi","Bells","Marimba","Dusk"],
 ...
 es:{
  ...
  locs:{hq:"Meridian HQ",f2:"Piso 2 · Expansión",st:"Calle Meridian",lc:"La Cocina",lo:"La Obra · Estudio",ex:"Calle Dos · Cuadra de expansión",me:"El Mercado Robles"},
...
4. Nada se publica como ${p.n} sin aprobación humana. ${p.n} no puede aprobar. ${p.n} es una gran mascota.`,
  ...
  updToast:"¡actualizado! Hay cosas nuevas.",lbCam:"Cámara",camTop:"🗺️ Cenital",camFront:"🏘 Frontal 2.5D",camIso:"◆ Isométrica",
  ...
  howl:"AUUUUUU…",
  beagleTreat:["¡Un premio! La cola despega.","Lo acepta con cuidado, como un caballero.","Crunch. Eres su persona favorita por una hora.","Recargado — ahorita te trae lo que sea."],isoEdit:"Cambia la cámara a Cenital para editar casillas.",lbMusic:"Música",musOn:"🔊 Activa",musOff:"🔇 Silenciada",tunes:["🎼 Auto","Lo-fi","Campanas","Marimba","Atardecer"],
