...
4. Nothing posts as ${p.n} without human approval. ${p.n} cannot approve. ${p.n} is a very good pet.`,
  ...
  howl:"AWOOOOO…",
  beagleTreat:["A treat! The tail achieves liftoff.","He accepts it gently, like a gentleman.","Crunch. You are his favorite person for the next hour."],isoEdit:"Switch the camera to Top-down to edit tiles.",lbMusic:"Music",musOn:"🔊 On",musOff:"🔇 Muted",tunes:["🎼 Auto","Lo-fi","Bells","Marimba","Dusk"],
...
4. Nada se publica como ${p.n} sin aprobación humana. ${p.n} no puede aprobar. ${p.n} es una gran mascota.`,
  ...
  howl:"AUUUUUU…",
  beagleTreat:["¡Un premio! La cola despega.","Lo acepta con cuidado, como un caballero.","Crunch. Eres su persona favorita por una hora."],isoEdit:"Cambia la cámara a Cenital para editar casillas.",lbMusic:"Música",musOn:"🔊 Activa",musOff:"🔇 Silenciada",tunes:["🎼 Auto","Lo-fi","Campanas","Marimba","Atardecer"],
