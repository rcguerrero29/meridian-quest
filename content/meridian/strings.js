...
4. Nothing posts as ${p.n} without human approval. ${p.n} cannot approve. ${p.n} is a very good pet.`,
  ...
  langQuick:"🌐 Español",
  flavor:{"□":["Your boxes. Taped, labelled in your own handwriting, still where the movers left them."],
...
4. Nada se publica como ${p.n} sin aprobación humana. ${p.n} no puede aprobar. ${p.n} es una gran mascota.`,
  ...
  langQuick:"🌐 English",
  flavor:{"□":["Tus cajas. Con cinta, rotuladas con tu letra, todavía donde las dejaron."],
