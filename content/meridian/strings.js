...
const UI={
 en:{
  ...
  mepi1:"Saturday, closing time. Doña Chelo counts the drawer twice, the way she has for thirty years, and this time the number matches what the screen said all week. “You didn't build me a robot,” she says. “You built me a Tuesday I can trust.” Frijol sleeps on the scale. Outside, somebody is laying track.",
  mepi2:"Saturday, closing time. Some of it stuck, some of it Nando quietly went back to doing by hand. Doña Chelo shrugs. “Half of it works. That's more than the last guy.” She writes your name on the wall by the register, next to the permit — and under a name in older handwriting you don't recognize yet.",
  mepi3:"Saturday, closing time. The mercado survived you. Most of the list is still a list, and the pilot is a folder nobody opens — but Doña Chelo hands you a bag of pan dulce anyway. “Come back when you've thought about it.” The door does not lock behind you.",
...
4. Nothing posts as ${p.n} without human approval. ${p.n} cannot approve. ${p.n} is a very good pet.`,
 ...
 es:{
  ...
  mepi1:"Sábado, hora de cerrar. Doña Chelo cuenta la caja dos veces, como lo ha hecho por treinta años, y esta vez el número coincide con lo que la pantalla dijo toda la semana. “No me construiste un robot,” dice. “Me construiste un martes en el que puedo confiar.” Frijol duerme sobre la báscula. Afuera, alguien está tendiendo vía.",
  mepi2:"Sábado, hora de cerrar. Algo pegó, algo Nando volvió a hacer a mano sin decir nada. Doña Chelo se encoge de hombros. “La mitad sirve. Es más que el anterior.” Escribe tu nombre en la pared junto a la caja, al lado del permiso — debajo de un nombre con letra más vieja que todavía no reconoces.",
  mepi3:"Sábado, hora de cerrar. El mercado te sobrevivió. Casi toda la lista sigue siendo lista, y el piloto es una carpeta que nadie abre — pero Doña Chelo igual te da una bolsa de pan dulce. “Vuelve cuando lo hayas pensado.” La puerta no se cierra con llave detrás de ti.",
