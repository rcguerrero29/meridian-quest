...
const UI={
 en:{
  ...
  mepi3:"Saturday, closing time. The mercado survived you. Chava still rings everything as chile, and the pilot is a folder nobody opens — but Doña Chelo hands you a bag of pan dulce anyway. “Come back when you've thought about it.” The door does not lock behind you.",
...
4. Nothing posts as ${p.n} without human approval. ${p.n} cannot approve. ${p.n} is a very good pet.`,
 ...
 es:{
  ...
  mepi3:"Sábado, hora de cerrar. El mercado te sobrevivió. Chava sigue cobrando todo como chile y el piloto es una carpeta que nadie abre — pero Doña Chelo igual te da una bolsa de pan dulce. “Vuelve cuando lo hayas pensado.” La puerta no se cierra con llave detrás de ti.",
