...
| 06 | Process & Exception Map | How work flows, who signs, which step can't be taken back | Taller Herrera — *The last visit* (❗El papel; written 2026-09-02) |
...
| 04 | Pilot Review | Did it pay off — and should we stop? | El Mercado — *The Monday number*; Limpieza Velázquez — *The last visit: the van* (the same paper in two rooms is the proof the skill travels) |
| 05 | Decision Log | The running record of calls and why | The decision report export |
| 07 | What It Answers, What It Refuses, Who It Hands To | Scope as three lists, tested, in both languages | Nolasco Tax & Notario — *The last visit: the file cabinet* (written 2026-09-02) |
