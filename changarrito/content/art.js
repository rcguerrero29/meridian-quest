...
/* win is the rect the art actually paints — (7,11,18,14). It said [7,13,18,11], two pixels down
   and three short, and three calaveritas stand in this front: the engine's own guard caught it on
   2026-09-17, in the town, the same day the same mismatch was found in Meridian's Q and Z. A
   window declared somewhere the glass is not is a sill somewhere the wall is. */
const TILEMETA={I:{lift:13,kind:"facade",win:[[7,11,18,14]],awn:9}};
const TILEART={I:rc=>{const{sx,sy}=rc;
  ...
  drawPanes(ctx,"I",sx,sy,{glass:false});}};   /* a reveal, a lintel and the ledge the calaveritas stand on */
